        ...
        <main className="flex-1 lg:ml-64 flex items-center justify-center">
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                You need to sign in to access API documentation
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-emerald-600 font-medium">Authenticated</span>
                  </div>
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-base">Auto-Authentication</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-base">Try It Out</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-base">SOC2 Compliant</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
